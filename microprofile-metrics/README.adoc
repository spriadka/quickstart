...
mvn archetype:generate \
    -DgroupId=org.wildfly.quickstart.microprofile.metrics \
...
Create `org.wildfly.quickstart.microprofile.metrics.JaxRsApplication` with the following
content:

NOTE: The new file should be created in
`src/main/java/org/quickstart/microprofile/metrics/JaxRsApplication.java`.
...
`org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker`:
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.checkIfPrime": 0
}
----
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.checkIfPrime": {
        "unit": "none",
        "type": "counter",
        "description": "",
        "displayName": "",
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.performedChecks": {
        "unit": "none",
        "type": "counter",
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.performedChecks": 3,
    "checksTimer": {
        "p99": 0.136153,
        "min": 0.01075,
        "max": 0.136153,
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.highestPrimeNumberSoFar": 29,
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.performedChecks": 3,
    "checksTimer": {
        "p99": 0.187263,
        "min": 0.02916,
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.highestPrimeNumberSoFar": 2,
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.performedChecks": 0,
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.parallelAccess": {
        "current": 3,
        "min": 0,
        "max": 0
    },
...
----
{
    "org.wildfly.quickstart.microprofile.metrics.PrimeNumberChecker.highestPrimeNumberSoFar": 7,
